...
from AbishnoiRobot.modules.helper_funcs.misc import split_message
from AbishnoiRobot.modules.helper_funcs.string_handling import split_quotes
from AbishnoiRobot.modules.log_channel import loggable
from AbishnoiRobot.modules.sql import warns_sql as sql
...
def warn(
    ...
    if num_warns >= limit:
        ...
        # message.bot.send_sticker(chat.id, BAN_STICKER)  # Abishnoi's sticker
        keyboard = None
        log_reason = (

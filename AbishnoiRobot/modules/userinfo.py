...
from AbishnoiRobot.__main__ import STATS, TOKEN, USER_INFO
import AbishnoiRobot.modules.sql.userinfo_sql as sql
from AbishnoiRobot.modules.disable import DisableAbleCommandHandler
from AbishnoiRobot.modules.sql.global_bans_sql import is_user_gbanned
from AbishnoiRobot.modules.sql.afk_sql import is_afk, check_afk_status
from AbishnoiRobot.modules.sql.users_sql import get_user_num_chats
from AbishnoiRobot.modules.helper_funcs.chat_status import sudo_plus
from AbishnoiRobot.modules.helper_funcs.extraction import extract_user
from AbishnoiRobot import telethn as AbishnoiTelethonClient, TIGERS, DRAGONS, DEMONS
...
def info(update: Update, context: CallbackContext):
    ...
    if disaster_level_present:
        text += ' \n[<a href="https://t.me/real_homies">ᴄʟɪᴄᴋ ʜᴇʀᴇ ᴛᴏ ᴋɴᴏᴡ ᴡʜᴀᴛ ɪs ᴅɪsᴀsᴛᴇʀ ʟᴇᴠᴇʟs.</a>]'.format(
            bot.username
        )

...
from AbishnoiRobot import dispatcher, LOGGER, OWNER_ID, JOIN_LOGGER, SUPPORT_CHAT
from AbishnoiRobot.__main__ import DATA_IMPORT
from AbishnoiRobot.modules.helper_funcs.chat_status import user_admin
from AbishnoiRobot.modules.helper_funcs.alternate import typing_action

# from AbishnoiRobot.modules.rules import get_rules
import AbishnoiRobot.modules.sql.rules_sql as rulessql

# from AbishnoiRobot.modules.sql import warns_sql as warnssql
import AbishnoiRobot.modules.sql.blacklist_sql as blacklistsql
from AbishnoiRobot.modules.sql import disable_sql as disabledsql

# from AbishnoiRobot.modules.sql import cust_filters_sql as filtersql
# import AbishnoiRobot.modules.sql.welcome_sql as welcsql
import AbishnoiRobot.modules.sql.locks_sql as locksql
...
def export_data(update, context):
    ...
    with open("AbishnoiRobot{}.backup".format(chat_id), "w") as f:
    ...
    context.bot.sendDocument(
        current_chat_id,
        document=open("AbishnoiRobot{}.backup".format(chat_id), "rb"),
        caption="📤*Successfully Exported backup:*\nChat: `{}`\nChat ID: `{}`\nOn: `{}`\n\nNote: This `AbishnoiRobot-Backup` was specially made for notes 📚.".format(
            chat.title, chat_id, tgl
        ),
        timeout=360,
    ...
    os.remove("AbishnoiRobot{}.backup".format(chat_id))  # Cleaning file
